...
\begin{frame}{Slide 2 --- Headline honnête : 0.92 sur cible Chaos Mesh}
  ...
  \begin{block}{Headline défensif final}
    \centering
    \begin{tabular}{lcl}
      \toprule
      \textbf{Évaluation} & \textbf{macro-AUROC} & \textbf{IC 95\,\% bootstrap} \\
      \midrule
      H3 circulaire (labels EWAT, à reframer)   & 0.987 ± 0.011 & --- \\
      \rowcolor{black!8}
      \textbf{B2 LR-OvR sur Chaos Mesh, v4\_strat} & $\mathbf{0.920}$  & \textbf{[0.878, 0.956]} \\
      \rowcolor{black!8}
      \textbf{B1 best (instance norm + last)}      & $\mathbf{0.941}$  & \textbf{[0.909, 0.970]} \\
      LOSO macro-AUROC (15 folds, retrain par fold) & 0.930 ± 0.007 & --- \\
      C1 STGCN end-to-end sur Chaos Mesh         & 0.863 & [0.823, 0.905] \\
      \bottomrule
    \end{tabular}
  \end{block}
